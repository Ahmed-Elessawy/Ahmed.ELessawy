...
echo //Author : Ahmed Elessawy>%PROG%  rem :you can write what you want to be written every time you create a file here
									   rem like your name or file guard and the same at each echo message after creating a file						
cd ..
