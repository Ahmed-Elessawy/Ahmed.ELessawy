###########################################################################
## Makefile generated for Simulink model 'State_Calc'. 
## 
## Makefile     : State_Calc.mk
## Generated on : Sun Jan 08 15:09:40 2023
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/State_Calc.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
MODELREF_LINK_RSPFILE_NAME = State_Calc_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = State_Calc_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/State_Calc.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/State_Calc_ert_rtw -I$(START_DIR) -I$(START_DIR)/Topic3 -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=State_Calc -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/State_Calc_ert_rtw/State_Calc.c

MAIN_SRC = $(START_DIR)/State_Calc_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/State_Calc_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
