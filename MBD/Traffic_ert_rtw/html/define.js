...
this.def["Traffic_DW"] = {file: "Traffic_c.html",line:34,type:"var"};
this.def["Traffic_M_"] = {file: "Traffic_c.html",line:37,type:"var"};
this.def["Traffic_M"] = {file: "Traffic_c.html",line:38,type:"var"};
this.def["Traffic_step"] = {file: "Traffic_c.html",line:41,type:"fcn"};
this.def["Traffic_initialize"] = {file: "Traffic_c.html",line:122,type:"fcn"};
this.def["Traffic_terminate"] = {file: "Traffic_c.html",line:140,type:"fcn"};
this.def["DW_Traffic_T"] = {file: "Traffic_h.html",line:49,type:"type"};
this.def["RT_MODEL_Traffic_T"] = {file: "Traffic_types_h.html",line:28,type:"type"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["Traffic_c.html"] = "../Traffic.c";
	this.html2Root["Traffic_c.html"] = "Traffic_c.html";
	this.html2SrcPath["Traffic_h.html"] = "../Traffic.h";
	this.html2Root["Traffic_h.html"] = "Traffic_h.html";
	this.html2SrcPath["Traffic_private_h.html"] = "../Traffic_private.h";
	this.html2Root["Traffic_private_h.html"] = "Traffic_private_h.html";
	this.html2SrcPath["Traffic_types_h.html"] = "../Traffic_types.h";
	this.html2Root["Traffic_types_h.html"] = "Traffic_types_h.html";
...
var fileList = [
"ert_main_c.html","Traffic_c.html","Traffic_h.html","Traffic_private_h.html","Traffic_types_h.html","rtwtypes_h.html"];
