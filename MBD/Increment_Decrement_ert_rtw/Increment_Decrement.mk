###########################################################################
## Makefile generated for Simulink model 'Increment_Decrement'. 
## 
## Makefile     : Increment_Decrement.mk
## Generated on : Thu Dec 29 22:17:18 2022
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Increment_Decrement.exe
...
PRODUCT_NAME              = Increment_Decrement
MAKEFILE                  = Increment_Decrement.mk
COMPUTER                  = PCWIN64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
MODELREF_LINK_RSPFILE_NAME = Increment_Decrement_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Increment_Decrement_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Increment_Decrement.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/Increment_Decrement_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Increment_Decrement -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/Increment_Decrement_ert_rtw/Increment_Decrement.c

MAIN_SRC = $(START_DIR)/Increment_Decrement_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/Increment_Decrement_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
