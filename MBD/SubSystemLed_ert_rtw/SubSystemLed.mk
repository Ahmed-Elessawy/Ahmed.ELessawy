###########################################################################
## Makefile generated for Simulink model 'SubSystemLed'. 
## 
## Makefile     : SubSystemLed.mk
## Generated on : Thu Dec 29 21:58:37 2022
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SubSystemLed.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
MODELREF_LINK_RSPFILE_NAME = SubSystemLed_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = SubSystemLed_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SubSystemLed.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/SubSystemLed_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=SubSystemLed -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/SubSystemLed_ert_rtw/SubSystemLed.c

MAIN_SRC = $(START_DIR)/SubSystemLed_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/SubSystemLed_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
