###########################################################################
## Makefile generated for Simulink model 'Programmer_Calc'. 
## 
## Makefile     : Programmer_Calc.mk
## Generated on : Tue Dec 27 11:45:30 2022
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Programmer_Calc.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
MODELREF_LINK_RSPFILE_NAME = Programmer_Calc_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Programmer_Calc_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Programmer_Calc.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/Programmer_Calc_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Programmer_Calc -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/Programmer_Calc_ert_rtw/Programmer_Calc.c

MAIN_SRC = $(START_DIR)/Programmer_Calc_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/Programmer_Calc_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
