###########################################################################
## Makefile generated for Simulink model 'whileee'. 
## 
## Makefile     : whileee.mk
## Generated on : Tue Dec 27 13:21:26 2022
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/whileee.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
MODELREF_LINK_RSPFILE_NAME = whileee_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = whileee_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/whileee.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/whileee_ert_rtw -I$(START_DIR) -IF:/ITI/MatLab_WorkSpace/MBD -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=whileee -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/whileee_ert_rtw/whileee.c $(START_DIR)/whileee_ert_rtw/whileee_data.c

MAIN_SRC = $(START_DIR)/whileee_ert_rtw/ert_main.c
...
OBJS = whileee.obj whileee_data.obj
...
%.obj : $(START_DIR)/whileee_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
