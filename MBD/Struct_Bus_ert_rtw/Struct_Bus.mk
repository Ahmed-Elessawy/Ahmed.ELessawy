###########################################################################
## Makefile generated for Simulink model 'Struct_Bus'. 
## 
## Makefile     : Struct_Bus.mk
## Generated on : Sun Jan 01 18:12:11 2023
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Struct_Bus.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
MODELREF_LINK_RSPFILE_NAME = Struct_Bus_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Struct_Bus_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Struct_Bus.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/Struct_Bus_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Struct_Bus -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/Struct_Bus_ert_rtw/Struct_Bus.c

MAIN_SRC = $(START_DIR)/Struct_Bus_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/Struct_Bus_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
