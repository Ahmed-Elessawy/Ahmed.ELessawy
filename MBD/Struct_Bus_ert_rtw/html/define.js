...
this.def["Struct_Bus_U"] = {file: "Struct_Bus_c.html",line:28,type:"var"};
this.def["Struct_Bus_Y"] = {file: "Struct_Bus_c.html",line:31,type:"var"};
this.def["Struct_Bus_M_"] = {file: "Struct_Bus_c.html",line:34,type:"var"};
this.def["Struct_Bus_M"] = {file: "Struct_Bus_c.html",line:35,type:"var"};
this.def["Struct_Bus_step"] = {file: "Struct_Bus_c.html",line:38,type:"fcn"};
this.def["Struct_Bus_initialize"] = {file: "Struct_Bus_c.html",line:66,type:"fcn"};
this.def["Struct_Bus_terminate"] = {file: "Struct_Bus_c.html",line:82,type:"fcn"};
this.def["ExtU_Struct_Bus_T"] = {file: "Struct_Bus_h.html",line:50,type:"type"};
this.def["ExtY_Struct_Bus_T"] = {file: "Struct_Bus_h.html",line:58,type:"type"};
this.def["Fault_t"] = {file: "Struct_Bus_types_h.html",line:34,type:"type"};
this.def["RT_MODEL_Struct_Bus_T"] = {file: "Struct_Bus_types_h.html",line:39,type:"type"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["Struct_Bus_c.html"] = "../Struct_Bus.c";
	this.html2Root["Struct_Bus_c.html"] = "Struct_Bus_c.html";
	this.html2SrcPath["Struct_Bus_h.html"] = "../Struct_Bus.h";
	this.html2Root["Struct_Bus_h.html"] = "Struct_Bus_h.html";
	this.html2SrcPath["Struct_Bus_private_h.html"] = "../Struct_Bus_private.h";
	this.html2Root["Struct_Bus_private_h.html"] = "Struct_Bus_private_h.html";
	this.html2SrcPath["Struct_Bus_types_h.html"] = "../Struct_Bus_types.h";
	this.html2Root["Struct_Bus_types_h.html"] = "Struct_Bus_types_h.html";
...
var fileList = [
"ert_main_c.html","Struct_Bus_c.html","Struct_Bus_h.html","Struct_Bus_private_h.html","Struct_Bus_types_h.html","rtwtypes_h.html"];
